//Copied on 24 May 2018 https://github.com/Bly7/OBJ-Loader
		...
		void VertexTriangluation(std::vector<unsigned int>& oIndices,
			...
			while(true) {
				...
				for(int i = 0; i < int(tVerts.size()); i++) {
					...
					float angle = math::AngleBetweenV3(pPrev.Position - pCur.Position, pNext.Position - pCur.Position) * static_cast<float>(180 / M_PI);
